...
import { Play, Star, Lock, ChevronRight, Code2 } from 'lucide-react';
...
export function LanguageSelectScreen({ languages, onSelect }: Props) {
  ...
  return (
    <div className="flex gap-5 px-6 py-4 min-h-[calc(100vh-73px)]">
      ...
      <div className="w-[340px] flex-shrink-0 flex flex-col gap-4">
        ...
        <div
          className="flex-1 rounded-[24px] p-6 flex flex-col transition-all duration-500 relative overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-inner transition-colors duration-500"
              style={{
          ...
          {/* Terminal/Preview más realista */}
          <div className="rounded-xl overflow-hidden mb-6 shadow-xl relative z-10" style={{ background: '#0d1117', border: '1px solid #30363d' }}>
            <div className="flex items-center gap-2 px-4 py-3 flex-shrink-0" style={{ background: '#161b22', borderBottom: '1px solid #30363d' }}>
              <div className="flex gap-1.5">
                <div className="w-3 h-3 rounded-full bg-[#ff5f56] border border-[#e0443e]" />
                <div className="w-3 h-3 rounded-full bg-[#ffbd2e] border border-[#dea123]" />
                <div className="w-3 h-3 rounded-full bg-[#27c93f] border border-[#1aab29]" />
              </div>
              <span className="text-[11px] ml-2 font-mono text-[#8b949e]">
                preview.{lang.name.toLowerCase()}
              </span>
            </div>
            <pre className="p-4 text-[13px] leading-relaxed font-mono overflow-auto scrollbar-thin scrollbar-thumb-gray-700" style={{ color: '#e6edf3', maxHeight: '160px' }}>
              {previewCode}
            </pre>
          </div>
      ...
      <div className="flex-1 flex flex-col gap-4 pl-2">
        ...
        {/* AQUÍ ESTÁ LA MAGIA DE LA DISTRIBUCIÓN */}
          ...
          {languages.map((l, i) => {
            ...
            return (
              <button
                ...
                className="relative rounded-2xl p-4 text-left transition-all duration-200 overflow-hidden flex flex-col h-full"
                style={{
